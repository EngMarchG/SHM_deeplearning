...
Pot_beam, Kin_beam = calculate_energies(x, qe, h_e, beta_e, E_e, J_e, A_e, ro_e, chi_beam, eps_beam, ve_beam, ue_beam)
...
index_modes = get_mode_indices(lamb_r, phis_norm, N_plots)
...
for j in range(N_plots):
    for e in range(N_ele_tot):
        ...
        substitutions = {
            Qglo_pel_curr1_mode: phis_plots[pel[e, 0] - 1, j],
            Qglo_pel_curr2_mode: phis_plots[pel[e, 1] - 1, j],
            Qglo_pel_curr3_mode: phis_plots[pel[e, 2] - 1, j],
            Qglo_pel_curr4_mode: phis_plots[pel[e, 3] - 1, j],
            Qglo_pel_curr5_mode: phis_plots[pel[e, 4] - 1, j],
            Qglo_pel_curr6_mode: phis_plots[pel[e, 5] - 1, j],
